...
# Эффективность: O(n), где n - количество элементов в первом списке.
# Конвертация множеств в списки и наоборот - O(m), где  - длина коллекции. 
# вычитание множеств - O(m), где m - длина первого множества в выражении
...
# Эффективность: O(n + m), где n - длина list_1, а m - длина list_2.
# Это складывается из 2-х операций: конвертации list_2 в множество и итерации по list_1.
# Конвертация list_2 в множество займет O(m) времени.
# Операция проверки наличия элемента в множестве занимает O(1),
# поэтому при итерации по list_1, для каждого элемента проверка займет O(1),
